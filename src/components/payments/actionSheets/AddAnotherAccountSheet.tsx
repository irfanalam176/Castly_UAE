...
type Props = {
  addsheetRef: React.RefObject<ActionSheetRef | null>;
  onSave?: (data: {
    bankName: string;
    accountType: string;
...
const AddAnotherAccountSheet = ({ addsheetRef, onSave }: Props) => {
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => addsheetRef.current?.hide()}
        >
...
export default AddAnotherAccountSheet;
